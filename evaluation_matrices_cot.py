#comparing the cot generated music to the GOT, TOT, after chat_BOT generated music evalution matrices
import librosa
import os
import numpy as np
import pandas as pd
...
output_dir = "evaluation_results_cot"
os.makedirs(output_dir, exist_ok=True)

with open(f"{output_dir}/evaluation_results_cot.txt", "w") as f:
